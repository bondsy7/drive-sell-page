...
const ALL_ACTIONS: { key: string; label: string; category: string; defaults: Record<string, number> }[] = [
  ...
  { key: 'video_generate', label: 'Video (Veo Fast)', category: 'Video', defaults: { schnell: 10, qualitaet: 10, premium: 15, turbo: 10, ultra: 20 } },
  { key: 'video_generate_standard', label: 'Video (Veo Standard)', category: 'Video', defaults: { schnell: 15, qualitaet: 15, premium: 20, turbo: 15, ultra: 25 } },
  { key: 'video_generate_audio', label: 'Video (Veo Std + Audio)', category: 'Video', defaults: { schnell: 20, qualitaet: 20, premium: 25, turbo: 20, ultra: 30 } },
  ...
  { key: 'spin360_generate', label: '360° Spin – Frame-Gen (Image)', category: '360° Spin', defaults: { schnell: 20, qualitaet: 25, premium: 30, turbo: 25, ultra: 35 } },
  { key: 'spin360_video', label: '360° Spin – Video (Veo)', category: '360° Spin', defaults: { schnell: 10, qualitaet: 10, premium: 15, turbo: 10, ultra: 20 } },
