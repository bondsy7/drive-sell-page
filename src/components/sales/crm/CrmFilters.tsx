    ...
    <div className="space-y-2">
      ...
      <div className="flex flex-wrap gap-2">
        <Select value={filterStage} onValueChange={onFilterStage}>
          <SelectTrigger className="w-full sm:w-[160px]"><SelectValue placeholder="Phase" /></SelectTrigger>
          <SelectContent>
        ...
        <Select value={filterIntent} onValueChange={onFilterIntent}>
          <SelectTrigger className="w-full sm:w-[160px]"><SelectValue placeholder="Interesse" /></SelectTrigger>
          <SelectContent>
