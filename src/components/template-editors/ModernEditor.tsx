          ...
          <AccordionContent className="pb-5">
            <div className="flex flex-wrap gap-2">
              {(data.vehicle.features || []).map((f, i) => (
                <span key={i} className="group text-xs border border-primary/20 bg-primary/5 text-foreground px-3.5 py-2 rounded-full inline-flex items-center gap-1.5 hover:bg-primary/10 transition-colors">
