    ...
    <div
      ...
      onClick={() => {
        if (pipeline.isRunning) {
          navigate('/generator');
        } else if (pipeline.isFinished) {
          const folderParam = pipeline.galleryFolder ? `&folder=${encodeURIComponent(pipeline.galleryFolder)}` : '';
          navigate(`/dashboard?tab=gallery${folderParam}`);
