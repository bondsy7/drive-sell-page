...
interface StdExteriorConfig {
  ...
  /** Generationstoleranz (Prompt). */
  readonly azimuthToleranceDeg: number;
  /** Validationstoleranz (QA), immer >= Generationstoleranz. */
  ...
  /** Nur bei Perspektiven mit echtem Seitenbezug true. */
...
function stdExterior(cfg: StdExteriorConfig): PerspectiveSpec {
  return {
    ...
    cameraGuidance: {
      ...
      targetFocalLengthMm: cfg.targetFocalLengthMm,
      focalLengthMinMm: cfg.focalLengthMinMm,
      focalLengthMaxMm: cfg.focalLengthMaxMm,
      semanticConstraints: [
...
export const STANDARD_EXTERIOR_SPECS: readonly PerspectiveSpec[] = [
  stdExterior({
    ...
    azimuthValidationToleranceDeg: 9,
    targetFocalLengthMm: 70,
    focalLengthMinMm: 55,
    focalLengthMaxMm: 85,
    sideMustMatch: false,
  ...
  stdExterior({
    ...
    azimuthValidationToleranceDeg: 11,
    targetFocalLengthMm: 55,
    focalLengthMinMm: 45,
    focalLengthMaxMm: 75,
    sideMustMatch: true,
