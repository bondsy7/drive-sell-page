...
import moto34Front from '@/assets/moto-perspectives/34front.webp.asset.json';
import motoSideLeft from '@/assets/moto-perspectives/side-left.webp.asset.json';
import motoSideRight from '@/assets/moto-perspectives/side-right.webp.asset.json';
import motoRear from '@/assets/moto-perspectives/rear.webp.asset.json';
import motoCockpit from '@/assets/moto-perspectives/rider-seat.webp.asset.json';
