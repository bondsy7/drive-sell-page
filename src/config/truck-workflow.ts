  ...
  if (cfg.hasCab) {
    slots.push(
      slot({
        ...
        label: '3/4 Front links',
        sketch: 'cab_34_front_left',
        hint: 'Fahrerhaus vollständig, Kamera auf Scheinwerferhöhe.',
        required: true,
        aspect: '4/3',
        capture: 'environment',
      ...
      slot({
        ...
        hint: 'Linke Fahrzeugseite vollständig und gerade.',
        required: true,
        aspect: '2/1',
        capture: 'environment',
      ...
      slot({
        ...
        hint: 'Rechte Fahrzeugseite vollständig und gerade.',
        required: true,
        aspect: '2/1',
        capture: 'environment',
      ...
      slot({
        ...
        label: 'Front frontal',
        sketch: 'cab_front',
        hint: 'Front mit Grill und Scheinwerfern.',
        required: false,
        aspect: '4/3',
        capture: 'environment',
        coverageTags: ['front'],
      ...
      slot({
        ...
        hint: 'Spiegel oder Kamerasystem an der A-Säule.',
        required: true,
        aspect: '4/3',
        capture: 'environment',
      ...
      slot({
        ...
        label: 'Fahrersitz',
        sketch: 'driver_seat',
        hint: 'Fahrersitz, Lenkrad und Armaturen.',
        required: false,
        aspect: '4/3',
        capture: 'environment',
      ...
      slot({
        ...
        hint: 'Beifahrersitz und Türbereich.',
        required: false,
        aspect: '4/3',
        capture: 'environment',
      ...
      slot({
        ...
        hint: 'Schlafbereich und Staufächer.',
        required: false,
        aspect: '4/3',
        capture: 'environment',
  ...
  if (cfg.key === 'tractor_unit') {
    slots.push(
      slot({
        ...
        label: 'Sattelplatte / Rahmen',
        sketch: 'fifth_wheel',
        hint: 'Sattelplatte und Rahmen hinter dem Fahrerhaus.',
        required: true,
        aspect: '4/3',
        capture: 'environment',
