...
<body>
  <div class="container">
    <div class="hero">
      ${imageBase64 ? `<span style="position:relative;display:block"><img id="mainImg" src="${imageBase64}" alt="${withAiDisclosureAlt(`${data.vehicle.brand} ${data.vehicle.model}`)}"/>${buildAiDisclosureImageOverlayHTML("landing")}</span>` : ''}
