...
<body>
  <div class="container">
    ...
    ${hasConsumption ? `<div class="section"><h3>Verbrauch & Emissionen</h3>
      <div class="cons-grid"><div>${consumptionRows}</div><div style="display:flex;flex-direction:column;align-items:center;justify-content:center"><div style="font-size:12px;font-weight:600;margin-bottom:8px;color:#ef4444">CO₂-Effizienz</div>${getCO2LabelHTML(consumption.co2Class||'A', true)}</div></div>
