...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'E-Mail-Adresse bestätigen | autohaus.ai',
  invite: 'Ihre Einladung zu autohaus.ai',
  magiclink: 'Ihr Anmeldelink für autohaus.ai',
  recovery: 'Passwort für autohaus.ai zurücksetzen',
  email_change: 'Neue E-Mail-Adresse bestätigen | autohaus.ai',
  reauthentication: 'Ihr Bestätigungscode für autohaus.ai',
}
...
const SAMPLE_PROJECT_URL = "https://drive-sell-page.lovable.app"
...
async function handleWebhook(req: Request): Promise<Response> {
  ...
  const { error: enqueueError } = await supabase.rpc('enqueue_email', {
    ...
    payload: {
      ...
      subject: EMAIL_SUBJECTS[emailType] || 'Mitteilung von autohaus.ai',
      html,
      text,
